...
However, the generalization gradient was shallower than in experiment 1 (Fig. \ref{fig:results}b; gaussian width = 0.75 +/ 0.02 for experiment 1, 1.09 +/- 0.05 for experiment 2). 
...
Only a low level of generalization was observed (Fig. \ref{fig:results}d), with a generalization width (0.66 +/- 0.05) similar to that observed in the first experiment, Single-Linear.  
